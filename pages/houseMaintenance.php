...
$informations = $manager->getInformationByLocation("houseMaintenance.php");
?>
    <main>
        <h1 class="colorBlue">ENTRETIEN<span class="colorGreen"> MAISON</span></h1>
        <?php
        $token = true;
