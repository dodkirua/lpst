...
$informations = $manager->getInformationByLocation("sweetGroceries.php");
?>
    <main>
        <h1 class="colorBlue">ÉPICERIE<span class="colorGreen"> SUCRÉE</span></h1>
        <?php
        $token = true;
