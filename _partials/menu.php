<header>
    ...
    if (session_id() != "") {
        ...
        <div class="log3">
            ...
            <a class="buttonClassic log4" href="#"><i class="fas fa-shopping-basket"></i></a>
